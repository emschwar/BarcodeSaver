...
public final class IntentIntegrator {
   ...
   * same, but uses default English labels.
   */
  public static void shareText(Activity activity, CharSequence text, String format) {
    shareText(activity, text, DEFAULT_TITLE, DEFAULT_MESSAGE, DEFAULT_YES, DEFAULT_NO, format);
  }
  ...
  public static void shareText(Activity activity,
    ...
    if (format == null) {
    	format = QR_CODE_TYPES;
    }
    intent.putExtra("ENCODE_TYPE", "TEXT_TYPE");
    intent.putExtra("ENCODE_DATA", text);
    intent.putExtra("com.google.zxing.client.android.ENCODE_FORMAT", format);
    try {
      activity.startActivity(intent);
    } catch (ActivityNotFoundException e) {
